...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_file_split_process_merge" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#88b279c8#;
   pragma Export (C, u00001, "main_ada_file_split_process_mergeB");
   ...
   u00191 : constant Version_32 := 16#8db484a3#;
   pragma Export (C, u00191, "pkg_ada_file_line_propertiesB");
   u00192 : constant Version_32 := 16#4f6a4cfe#;
   pragma Export (C, u00192, "pkg_ada_file_line_propertiesS");
   u00193 : constant Version_32 := 16#b37a0782#;
   pragma Export (C, u00193, "ada__directoriesB");
   u00194 : constant Version_32 := 16#18050e83#;
   pragma Export (C, u00194, "ada__directoriesS");
   u00195 : constant Version_32 := 16#ab4ad33a#;
   pragma Export (C, u00195, "ada__directories__validityB");
   u00196 : constant Version_32 := 16#498b13d5#;
   ...
   u00199 : constant Version_32 := 16#620302a2#;
   pragma Export (C, u00199, "system__file_attributesS");
   u00200 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00200, "system__regexpB");
   u00201 : constant Version_32 := 16#65074bc8#;
   ...
   u00206 : constant Version_32 := 16#2e2d6009#;
   pragma Export (C, u00206, "pkg_ada_file_propertiesB");
   u00207 : constant Version_32 := 16#a1cb012e#;
   pragma Export (C, u00207, "pkg_ada_file_propertiesS");
   u00208 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00208, "system__concat_7B");
   u00209 : constant Version_32 := 16#baf2b71b#;
   pragma Export (C, u00209, "system__concat_7S");
   u00210 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00210, "system__concat_6B");
   u00211 : constant Version_32 := 16#94f2c1b6#;
   pragma Export (C, u00211, "system__concat_6S");
   u00212 : constant Version_32 := 16#b084dd28#;
   pragma Export (C, u00212, "pkg_ada_file_read_writeB");
   u00213 : constant Version_32 := 16#599134b6#;
   pragma Export (C, u00213, "pkg_ada_file_read_writeS");
   u00214 : constant Version_32 := 16#4fc9bc76#;
   pragma Export (C, u00214, "ada__command_lineB");
   u00215 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00215, "ada__command_lineS");
   u00216 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00216, "ada__numericsS");
   u00217 : constant Version_32 := 16#fe1ffede#;
   pragma Export (C, u00217, "ada__strings__boundedB");
   u00218 : constant Version_32 := 16#89c18940#;
   pragma Export (C, u00218, "ada__strings__boundedS");
   u00219 : constant Version_32 := 16#7ec26662#;
   pragma Export (C, u00219, "ada__strings__superboundedB");
   u00220 : constant Version_32 := 16#da6addee#;
   pragma Export (C, u00220, "ada__strings__superboundedS");
   u00221 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00221, "ada__strings__unbounded__text_ioB");
   u00222 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00222, "ada__strings__unbounded__text_ioS");
   u00223 : constant Version_32 := 16#e5b19cf0#;
   pragma Export (C, u00223, "pkg_ada_realtime_delaysB");
   u00224 : constant Version_32 := 16#f93ecfaf#;
   pragma Export (C, u00224, "pkg_ada_realtime_delaysS");
   u00225 : constant Version_32 := 16#2353cf5b#;
   pragma Export (C, u00225, "ada__real_time__delaysB");
   u00226 : constant Version_32 := 16#0a5c26d7#;
   pragma Export (C, u00226, "ada__real_time__delaysS");
   u00227 : constant Version_32 := 16#2323a8af#;
   pragma Export (C, u00227, "system__memoryB");
   u00228 : constant Version_32 := 16#1f488a30#;
   ...
   --  pkg_ada_file_line_properties%s
   --  pkg_ada_file_line_properties%b
   --  pkg_ada_file_properties%s
   --  pkg_ada_file_properties%b
   --  pkg_ada_file_read_write%s
   --  pkg_ada_file_read_write%b
   --  pkg_ada_realtime_delays%s
   --  pkg_ada_realtime_delays%b
   --  main_ada_file_split_process_merge%b
